...
- Tarifa o precio de un servicio regulado (electricidad, gas, agua, boleta, factura) → OFFICIAL_RECORD, REGULATED_TARIFF, primary_source_required true. No uses OFFICIAL_STATISTICS ni INDEC.
