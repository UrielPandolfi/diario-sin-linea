...
Limitación del matching: overlap ≥0.6 con bucket `other` puede marcar EQUIVALENT un utterance de recovery y un titular de hecho; C5 no repara Extraction. «Según» debe ir en la misma oración y antes de la afirmación; un «según» posterior o en otra superficie no sana. No hay embeddings ni umbral semántico nuevo.
